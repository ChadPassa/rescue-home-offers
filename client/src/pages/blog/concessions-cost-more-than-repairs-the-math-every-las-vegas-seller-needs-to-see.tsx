    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white border-b py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-900 mt-4">Concessions Cost More Than Repairs: The Math Every Las Vegas Seller Needs to See</h1>
      ...
      <div className="container mx-auto px-4 max-w-4xl py-8">
        <div className="rounded-xl overflow-hidden shadow-lg">
          <img 
            src="/images/blog/concessions-cost-more-than-repairs-the-math-every-las-vegas-seller-needs-to-see.jpg" 
            alt="Concessions Cost More Than Repairs - Calculator and house key on blueprint showing the true cost of seller concessions in Las Vegas - Rescue Home Offers"
