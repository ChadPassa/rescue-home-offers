...
export default function MarketReadyPillar() {
  return (
    <BlogPost
      ...
      description="In today's buyer's market, only turnkey homes sell. Learn why market-ready is essential and how to position your Las Vegas home for a successful sale."
      image="/images/blog/why-market-ready-is-the-only-way-to-sell-in-todays-las-vegas-market.jpg"
      slug="why-market-ready-is-the-only-way-to-sell-in-todays-las-vegas-market"
